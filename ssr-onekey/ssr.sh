...
function adduser(){
    ...
    read -p "(Default password: ssrPASSWORD):" shadowsockspwd
    [ -z "$shadowsockspwd" ] && shadowsockspwd="ssrPASSWORD"
    echo
    echo "---------------------------"
	...
	#添加用户
	cd ${ssrdir}
	python mujson_mgr.py -a -p ${shadowsocksport} -k ${shadowsockspwd} -m aes-256-cfb -O auth_sha1_v4 -o http_simple
